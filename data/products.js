...
export class Product {
    ...
    constructor(product_details) {
        ...
        this.keywords = product_details.keywords
    }
...
function searchCheck() {
    ...
    products = products.filter((product, i, products, bool) => { 
        const name = product.name.toLowerCase()

        product.keywords.forEach((key)=>{
            key = key.toLowerCase()
            if (key.includes(search.toLowerCase())) bool = true
        });
        
        return name.includes(search.toLowerCase()) || bool
    });
}
